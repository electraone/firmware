...
void BarVertical::onTouchDown([[maybe_unused]] const TouchEvent &touchEvent)
{
}

void BarVertical::onTouchUp([[maybe_unused]] const TouchEvent &touchEvent)
{
}
