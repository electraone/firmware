...
#define USB_MIDI_SYSEX_MAX 128 // must be a multiply of 4
...
extern void (*usb_midi_handleSysExPartial)(uint8_t cable, const uint8_t *data, uint16_t length, uint8_t complete);
...
class usb_midi_class
{
	public:
		...
		void setHandleSysEx (void (*fptr)(uint8_t, const uint8_t *data, uint16_t length, bool complete))
		{
			// type: 0xF0  SystemExclusive - multiple calls for message bigger than buffer
			usb_midi_handleSysExPartial = (void (*)(uint8_t, const uint8_t *, uint16_t, uint8_t))fptr;
		}
		void setHandleSystemExclusive (void (*fptr)(uint8_t, const uint8_t *data, uint16_t length, bool complete))
		{
			// type: 0xF0  SystemExclusive - multiple calls for message bigger than buffer
			usb_midi_handleSysExPartial = (void (*)(uint8_t, const uint8_t *, uint16_t, uint8_t))fptr;
		}
